...
function doGet(e){
  ...
  userProperties.setProperty('temperatureText', nowDatetime  + "accident site 事故資訊" + temperature);
...
function doPost(e) {
  ...
  if (typeof keyWords === 'undefined') {
    var keyWords = ["site", "accident","地點", "事故", "事故資訊"];
  }
  else {
    keyWords = keyWords.concat(["地點", "事故", "事故資訊"]);
  }
